...
Petition website for the Srnčí důl initiative, built with Next.js and Keystatic.
...
|----------|---------|-------------|
| `NEXT_PUBLIC_SITE_URL` | `https://petice.zasrncidul.cz` | Canonical site URL — used in sitemap and Open Graph metadata |
